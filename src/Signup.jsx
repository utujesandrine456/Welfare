      ...
      <div className="flex w-full h-screen bg-[#FFF]">
        ...
        <form className='flex flex-col gap-4 p-3 w-[500px] mx-auto my-8'>
          ...
          <div className="flex flex-col gap-1 mb-3">
            <label htmlFor="companyname" className="text-[15px]  font-medium text-gray-700">Full Name:</label>
            <input 
              type="text" 
          ...
          <button 
            type="submit"
            className='w-full py-2 px-4 mt-3 bg-[#178280] text-white font-medium rounded-lg hover:bg-[#269369] transition-colors duration-200'
          >
            Create Account
          </button>
